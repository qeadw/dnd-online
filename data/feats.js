...
const FEATS = {
    ...
    athlete: {
        ...
        abilityScoreIncrease: { choice: ["str", "dex"] }
    },
    actor: {
        name: "Actor",
        prerequisite: null,
        ...
        abilityScoreIncrease: { fixed: "cha" }
    },
    charger: {
        name: "Charger",
        prerequisite: null,
    ...
    durable: {
        ...
        abilityScoreIncrease: { fixed: "con" }
    },
    elementalAdept: {
    ...
    heavilyArmored: {
        ...
        abilityScoreIncrease: { fixed: "str" }
    },
    heavyArmorMaster: {
    ...
    keenMind: {
        ...
        abilityScoreIncrease: { fixed: "int" }
    },
    lightlyArmored: {
    ...
    observant: {
        ...
        abilityScoreIncrease: { choice: ["int", "wis"] }
    },
    polearmMaster: {
        name: "Polearm Master",
        prerequisite: null,
    ...
    resilient: {
        ...
        abilityScoreIncrease: { choice: ["str", "dex", "con", "int", "wis", "cha"] }
    },
    ritualCaster: {
        name: "Ritual Caster",
    ...
    tavernBrawler: {
        ...
        abilityScoreIncrease: { choice: ["str", "con"] }
    },
    tough: {
        name: "Tough",
        prerequisite: null,
